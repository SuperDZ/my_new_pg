...
#define CONFIGURE_ARGS " '--prefix=/home/postgresql/pg15/opt/pgsql' '--with-ssl=openssl'"
...
#define PG_VERSION_STR "PostgreSQL 15.3 on x86_64-pc-linux-gnu, compiled by gcc (GCC) 4.8.5 20150623 (Red Hat 4.8.5-44), 64-bit"
